...
knit: (function(inputFile, encoding) { 
      rmarkdown::render(inputFile,
                        encoding=encoding, 
                        output_file=file.path(dirname(inputFile), '../reports/', 'step-05-incorporate-addl-data.html')) })
...
**Test Set Sensitivity vs Specificity of rf w/o RCPTOT**
...
**Test Set Sensitivity vs Specificity of rf w/ RCPTOT**
