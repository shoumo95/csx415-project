...
```
Both in the training set and the test set these numbers seemed to be close to each other and we do notice that the Sales numbers are cluestred more towards the left of the scale. To visulaize this better we have created a distogram of the sales numbers for the traning set and the test set so that we can do a visual side by side analysis.
