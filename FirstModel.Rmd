...
Future steps might also include adding non-linear terms to the model or building other non-linear models such as **Decision Tree** or take advantage of ensemble learning by building a model using **Random Forest**.
