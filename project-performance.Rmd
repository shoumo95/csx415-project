...
The three of the indicators that we are planning on using for this model and the next models that we are planning on building are; $R^2$, Adjusted $R^2$ and the RMSE and below is a recap of these three indicators for our **training model**:
